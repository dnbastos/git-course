...
This repository is only to pratice git commands and github. So the code here is not relevant to the purpose, being used only as an example for practice. For this, it was chosen this HTML5 template:v
